 ...
 * Components.
 */
var UploadAndEarnComponent = /** @class */ (function () {
    function UploadAndEarnComponent() {
        console.log('Hello UploadAndEarnComponent Component');
        this.text = 'Hello World';
    }
    UploadAndEarnComponent = __decorate([
        Component({
    ...
    return UploadAndEarnComponent;
}());
export { UploadAndEarnComponent };
