...
var UserGuidePage = /** @class */ (function () {
    function UserGuidePage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    UserGuidePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad UserGuidePage');
    };
    UserGuidePage.prototype.gotoWelcome = function () {
        this.navCtrl.setRoot('WelcomePage');
    };
    UserGuidePage = __decorate([
        IonicPage(),
        Component({
