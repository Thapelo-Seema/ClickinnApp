...
var ApartmentDetailsPageModule = /** @class */ (function () {
    function ApartmentDetailsPageModule() {
    }
    ApartmentDetailsPageModule = __decorate([
        NgModule({
            declarations: [
    ...
    return ApartmentDetailsPageModule;
}());
export { ApartmentDetailsPageModule };
